...
part_type_shape(part_pw3, pt_shape_flare)
part_type_color2(part_pw3, $00FF1F, $FFFFFF)
part_type_life(part_pw3, 40, 80)
part_type_alpha2(part_pw3, 1, 0.4)
part_type_size(part_pw3, 0.05, 0.2, 0, 0.5)
part_type_direction(part_pw3, 45, 135, 0, 0)
part_type_speed(part_pw3, 1, 3, 0, 0)
part_type_gravity(part_pw3, 0.05, 270)
}
